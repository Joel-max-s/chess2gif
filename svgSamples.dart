...
class svgSamples {
  ...
  void placePiece(String piece, int x, int y) {
    ...
    switch (piece) {
      case 'r':
        pieceNotation = 'black-rook';
        break;
      case 'n':
        pieceNotation = 'black-knight';
        break;
      case 'b':
        pieceNotation = 'black-bishop';
        break;
      case 'q':
        pieceNotation = 'black-queen';
        break;
      case 'k':
        pieceNotation = 'black-king';
        break;
      case 'p':
        pieceNotation = 'black-pawn';
        break;
      case 'R':
        pieceNotation = 'white-rook';
        break;
      case 'N':
        pieceNotation = 'white-knight';
        break;
      case 'B':
        pieceNotation = 'white-bishop';
        break;
      case 'Q':
        pieceNotation = 'white-queen';
        break;
      case 'K':
        pieceNotation = 'white-king';
        break;
      case 'P':
        pieceNotation = 'white-pawn';
        break;
    }

    currentBoard += '<use xlink:href="#$pieceNotation" transform="translate(${x*45}, ${y*45})" />';
  }

  void makeBoard() {
    currentBoard += svgSetup + setChessBoard();
  }

  void makeSVG() {
    currentBoard += end;
    final filename = 'file.svg';
